...
"""
Pjensen extension descriptors
-----------------------------
Module which groups all the functions related with the computation of the
spatial correlation using an extensin of the Jensen model.

TODO
----
- Prepare the formalism and compute it.
"""
...
##################################################################
class Pjensen_plus(DescriptorModel):
    """
    ...
    """
    name_desc = "PJensen extension descriptors"
